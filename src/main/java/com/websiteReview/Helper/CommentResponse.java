...
public class CommentResponse {
    ...
    public CommentResponse(List<CommentDto> content, int pageNumber, int pageSize, int totalPages, boolean lastPage) {
        this.content = content;
        this.pageNumber = pageNumber;
        this.pageSize = pageSize;
        this.totalPages = totalPages;
    ...
    public String toString() {
        return "CommentResponse [content=" + content + ", pageNumber=" + pageNumber + ", pageSize=" + pageSize
